  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-purple-900 via-indigo-900 to-violet-900">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-pink-500/30 rounded-full blur-[100px] animate-blob"></div>
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-purple-500/30 rounded-full blur-[80px] animate-blob animation-delay-2000"></div>
        <div className="absolute top-1/2 left-1/2 w-[300px] h-[300px] bg-indigo-500/20 rounded-full blur-[60px] animate-blob animation-delay-4000"></div>
      </div>
...
<h1 className="text-2xl font-bold text-white">HostelFlow</h1>
        ...
        <div className="flex bg-white/10 backdrop-blur-md rounded-xl p-1 mb-6">
          <button
            ...
            className={"flex-1 py-2.5 px-4 rounded-lg text-sm font-medium transition-all duration-200 " + (role === "student" ? "bg-white text-indigo-600 shadow-lg" : "text-white/70 hover:text-white")}
          >
          ...
          <button
            ...
            className={"flex-1 py-2.5 px-4 rounded-lg text-sm font-medium transition-all duration-200 " + (role === "admin" ? "bg-white text-indigo-600 shadow-lg" : "text-white/70 hover:text-white")}
          >
            <span className="flex items-center justify-center gap-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 text-xs mt-1">Register as {role}</p>
          </div>
